...
import { getDocs, getDoc, doc, query, orderBy, limit, startAfter } from 'firebase/firestore'
  ...
  methods: {
    ...
    async getSongs() {
      ...
      if (this.songs.length) {
        const lastDoc = await getDoc(doc(songsCollection, this.songs[this.songs.length - 1].docID))
